...
// function to iterate the random walk
...
// nebular is the main function, to be exported
// [[Rcpp::export]]
NumericMatrix nebula(int iterations) {

  NumericMatrix segments(iterations, 5); // initially zero
